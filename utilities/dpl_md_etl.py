...
def process_hourly_volume(hourly_volume_df, edc_name):
    ...
    for date_type in ['SALES DATA', 'GENERATION DATA']:
        for type in ['RESIDENTIAL', 'TYPE I', 'TYPE II']:
            for market in ['DPL MD ALT', 'DPL MD SOS', 'DPL MD ELIG']:
                ...
                hourly_volume_data = {
                    ...
                    'EGS_HourlyVolume': sub_df_melted['volume']/1000 if market == 'DPL MD ALT' else 0,
                    'Default_HourlyVolume': sub_df_melted['volume']/1000 if market == 'DPL MD SOS' else 0,
                    'Eligible_HourlyVolume': sub_df_melted['volume']/1000 if market == 'DPL MD ELIG' else 0,
                    'VolumeComment': ''
                }
...
def main(base_path):
    ...
    hourly_volume_file_path_sales = {
        '2017_sales': f'{base_path}/DPLSOS.MD2017.SALES.xlsx',
        '2018_sales': f'{base_path}/DPLSOS.MD2018.SALES.xlsx',
        '2019_sales': f'{base_path}/DPLSOS.MD2019.SALES.xlsx',
        '2020_sales': f'{base_path}/DPLSOS.MD2020.SALES.xlsx',
        '2021_sales': f'{base_path}/DPLSOS.MD2021.SALES.xlsx',
        '2022_sales': f'{base_path}/DPLSOS.MD2022 SALES.xlsx',
        '2023_sales': f'{base_path}/DPLSOS.MD2023 SALES.xlsx',
        '2024_sales': f'{base_path}/DPLSOS.MD2024 SALES.xlsx',
        '2024_sales_by_may': f'{base_path}/DPL MD SOS  03.01.24 - 5.21.24 SALES.xlsx',
    }

    hourly_volume_file_path_generation = {
        '2017': f'{base_path}/DPL MD SOS 2017.xlsx',
        '2018': f'{base_path}/DPL MD SOS 2018.xlsx',
        '2019': f'{base_path}/DPL MD SOS 2019.xlsx',
        '2020': f'{base_path}/DPL MD SOS 2020.xlsx',
        '2021': f'{base_path}/DPL MD SOS 2021.xlsx',
        '2022': f'{base_path}/DPL MD SOS 2022.xlsx',
        '2023': f'{base_path}/DPL MD SOS 2023.xlsx',
        '2024': f'{base_path}/DPL MD SOS 2024.xlsx',
        '2024_by_may': f'{base_path}/DPL MD SOS 03.1.24 to 5.21.24.xlsx'
    }

    daily_volume_file_path = {
        '2017': f'{base_path}/2017 DPL MD CPLC, NSPLC and Customer Counts.xlsx',
        '2018': f'{base_path}/2018 DPL MD CPLC, NSPLC and customer count.xlsx',
        '2019': f'{base_path}/2019 DPL MD CPLC, NSPLC and customer count.xlsx',
        '2020': f'{base_path}/2020 DPL MD CPLC, NSPLC, and customer count.xlsx',
        '2021': f'{base_path}/2021 DPL MD CPLC, NSPLC, and customer count.xlsx',
        '2022': f'{base_path}/2022 DPL MD CPLC, NSPLC, and customer count.xlsx',
        '2023': f'{base_path}/2023 DPL MD CPLC, NSPLC, and customer count.xlsx',
        '2024': f'{base_path}/2024 DPL MD CPLC, NSPLC, and customer count.xlsx',
    }
    ...
    hourly_volume_file_path_generation_hist = find_xlsx_files_path(f'{base_path}/historical_data', 'DPL MD SOS')

    # Update hourly volume
    hourly_volume_df_hist = load_historical_hourly_volume(hourly_volume_file_path_sales_hist, hourly_volume_file_path_generation_hist)
    hourly_volume_df = pd.concat([hourly_volume_df, hourly_volume_df_hist], ignore_index=True)

    # Update daily and monthly volume
    daily_volume_df_hist = pd.read_excel(r"C:\Users\5DIntern3_2024\Work\DPL_MD\historical_data\daily_PLC&NSPL_hist.xlsx")
    monthly_volume_df_hist = pd.read_excel(r"C:\Users\5DIntern3_2024\Work\DPL_MD\historical_data\monthly_CustomerCount_hist.xlsx")
...
if __name__ == "__main__":
    base_path = 'C:\\Users\\5DIntern3_2024\\Work\\DPL_MD'
    main(base_path)
